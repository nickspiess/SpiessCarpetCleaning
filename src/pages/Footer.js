                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                            ...
                            {/* Address */}
                            <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 bg-white rounded-lg md:rounded-xl shadow-sm max-w-sm border border-slate-100">
                                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(247,167,25,0.1)' }}>
                                    <svg className="w-5 h-5 md:w-6 md:h-6" style={{ color: 'rgba(247,167,25,1)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                                    </svg>
                                </div>
                                <div>
                                    <p className="font-bold text-base md:text-lg text-slate-800">Our Location</p>
                                    <p className="text-slate-500 text-xs md:text-sm">2042 Wooddale Dr Ste 145, Woodbury, MN 55125</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="border-t border-slate-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="text-center md:text-left">
                            ...
                            50+ Years Experience · 100% Satisfaction Guaranteed
                            </p>
                        </div>
