...
sgMail.setApiKey(process.env.SENDGRID_API_KEY)
    ...
    async function sendEmail(req, res) {
        ...
        try {
            ...
            <div style="font-family: inherit; text-align: inherit"><br></div>
            <div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">For ${req.body.roomCount} rooms, ${req.body.stepCount} flights of steps, ${req.body.chairCount} chairs, ${req.body.loveseatCount} loveseats, and ${req.body.couchCount} couches, your price is looking to be no more than $${req.body.totalPrice}.</span></div>
            <div style="font-family: inherit; text-align: inherit"><br></div>
