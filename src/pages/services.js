...
export default function Services() {
  ...
  useEffect(() => {
    ...
    const sections = [
      ...
      { ref: faqSectionRef, id: 'serviceFaq' },
      { ref: ctaRef, id: 'cta' }
    ];
  ...
  const differenceFeatures = [
    {
      ...
      description: "We exclusively use BridgePoint cleaning solutions — the highest quality chemicals in the industry for superior cleaning results",
      icon: (
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Expert carpet, upholstery, and air duct cleaning services in the Twin Cities. 50+ years of experience, state-of-the-art BridgePoint cleaning solutions, 100% satisfaction guaranteed." />
      ...
      <div className="bg-gradient-to-b from-stone-50 via-slate-50/80 to-stone-50 min-h-screen">
        ...
        <section className="pb-16 md:pb-20 pt-8 md:pt-12 relative overflow-hidden">
          <div className="container-wide relative z-10">
            ...
            <div className={`flex flex-wrap justify-center gap-2 sm:gap-3 mb-10 transition-all duration-1000 ease-out delay-150 ${pageLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              {services.map((service, index) => (
                <button
                  key={service.id}
                  onClick={() => handleServiceChange(service.id)}
                  className={`px-4 sm:px-6 py-3 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 whitespace-nowrap ${
                ...
                <div className="relative rounded-3xl overflow-hidden bg-white lg:h-[580px]">
                  ...
                  <div className={`lg:col-span-3 p-8 pb-12 lg:p-12 lg:pb-16 flex flex-col justify-center transition-all duration-500 ${isAnimating ? 'opacity-0 translate-x-2' : 'opacity-100 translate-x-0'}`}>
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-xl">
                      {currentService.descriptionJsx ? (
                        <>
                          State-of-the-art, portable steam cleaning designed to restore your carpets to like-new condition. Using the BridgePoint system — the highest quality equipment in the industry — our advanced cleaning process removes deep-seated dirt, allergens, and stains for homeowners in Lakeville, <Link href="/carpet-cleaning-cottage-grove-mn" className="text-secondary-600 hover:text-secondary-700 underline">Cottage Grove</Link>, Minnetonka, Woodbury, and surrounding areas.
                        </>
                      ) : (
        ...
        <section ref={differenceRef} className="py-24 relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-stone-50">
          ...
          <div className="container-wide relative z-10">
            ...
            {/* Service FAQ Section */}
            <div ref={faqSectionRef} className={`mb-16 transition-all duration-1000 ease-out ${visibleSections.serviceFaq ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              <div className="text-center mb-10">
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">
                  Service Questions & Answers
                </h2>
                <p className="text-slate-600 max-w-xl mx-auto">
                  Common questions about our cleaning process and services
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    answer: "A typical carpet cleaning session takes about 20 to 30 minutes per room, depending on the size and condition of your carpets. Heavily soiled areas may require additional time to ensure thorough results.",
                    color: 'rgba(0, 168, 227, 1)'
                  },
                  {
                    question: "How long does it take for carpets to dry after cleaning?",
                    answer: "Most carpets dry within 4 to 6 hours. With good ventilation — such as opening windows or running fans — drying time can be reduced to as little as 2 to 4 hours. We recommend avoiding heavy foot traffic until fully dry.",
                    color: 'rgba(198, 25, 73, 1)'
                  },
                  {
                    question: "Do you offer pet odor and stain removal?",
                    answer: "Yes, we specialize in pet odor and stain removal using advanced enzymatic treatments that break down pet proteins at a molecular level, eliminating the source of the problem completely rather than just masking odors.",
                    color: 'rgba(247, 167, 25, 1)'
                  },
                  {
                    question: "What is the BridgePoint system?",
                    answer: "The BridgePoint system is the highest quality professional cleaning solution in the carpet cleaning industry. Its advanced chemical formulations break down deep-seated dirt, allergens, and stains more effectively than standard products — delivering a deeper, more thorough clean while remaining safe for your family and pets.",
                    color: 'rgba(0, 168, 227, 1)'
                  },
                  {
                    question: "Do you provide carpet cleaning service in Cottage Grove?",
                    answer: "Absolutely! We serve Cottage Grove and all surrounding communities in the Twin Cities metro area. Our Woodbury-based team regularly cleans carpets throughout Cottage Grove and nearby neighborhoods.",
                    color: 'rgba(198, 25, 73, 1)'
                  }
                ].map((faq, index) => {
